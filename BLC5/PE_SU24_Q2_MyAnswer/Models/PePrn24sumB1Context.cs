...
public partial class PePrn24sumB1Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CourseId).HasName("PK__Courses__8F1EF7AE0B1D712E");
            ...
            entity.HasMany(d => d.Categories).WithMany(p => p.Courses)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("CourseId", "CategoryId").HasName("PK__CourseCa__D24A1935579E489D");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__CourseCa__D54EE9B442D1B2D5");
        ...
        {
            entity.HasKey(e => new { e.UserId, e.CourseId }).HasName("PK__Enrollme__414FD875BA085342");
        ...
        {
            entity.HasKey(e => e.InstructorId).HasName("PK__Instruct__A1EF56E8027B435E");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__60883D904635DC84");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__B9BE370F69F01D7D");
